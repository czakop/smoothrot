...
def get_hadK(n: int) -> tuple[torch.Tensor, int]:
    ...
    elif n % 172 == 0: # llama2-7b intermediate: 11008 = 172 * 64
        return get_had172(), 172
    elif n % 108 == 0: # llama2-13b intermediate: 13824 = 108 * 128
        return get_had108(), 108
    elif n % 28 == 0: # llama3-8b & mistral-7b intermediate: 14336 = 28 * 512
        return get_had28(), 28
    else:
        raise ValueError("Invalid size for the rotation matrix.")
...
# Following functions have been adapted from https://github.com/Cornell-RelaxML/quip-sharp/blob/main/lib/utils/matmul_had.py
